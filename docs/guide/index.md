...
P0 does not provide domain-specific application modules. It also does not yet claim public production release qualification. Recovery requalification, the aggregate gate, and the final Runtime review remain separate tasks.
