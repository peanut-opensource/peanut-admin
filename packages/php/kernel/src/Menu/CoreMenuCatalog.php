...
final class CoreMenuCatalog
{
    ...
    public static function definitions(): array
    {
        return [
            ...
            new MenuDefinition('platform.audit.list', 'platform', 'platform', 'platform.governance', 'page', '平台审计', 'platform.audit.list', '/platform/audit', 'platform.audit.list', 'platform.audit.read', ['platform-web'], 14, 'ScrollText'),
        ];
    }
