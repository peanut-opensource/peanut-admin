...
{
    public function taskType(): string { return ImportExportService::TASK_TYPE; }
    public function resourceKey(): string { return ImportExportService::RESOURCE_KEY; }
    public function operation(): string { return 'create'; }

    public function build(AuthorizedOperationContext $context, array $input): TaskSubmission
    {
        if (array_keys($input) !== ['operation_key'] || !is_string($input['operation_key'])) throw ImportExportException::invalid();
