...
CREATE TABLE IF NOT EXISTS `pa_collaboration_session` (
  ...
  CONSTRAINT `chk_collaboration_session_engine` CHECK (`engine_name` REGEXP '^[a-z][a-z0-9]*([.-][a-z0-9]+)*$' AND `engine_version` <> ''),
...
CREATE TABLE IF NOT EXISTS `pa_collaboration_update_envelope` (
  ...
  CONSTRAINT `chk_collaboration_update_engine` CHECK (`engine_name` REGEXP '^[a-z][a-z0-9]*([.-][a-z0-9]+)*$' AND `engine_version` <> ''),
...
CREATE TABLE IF NOT EXISTS `pa_collaboration_snapshot_envelope` (
  ...
  CONSTRAINT `chk_collaboration_snapshot_engine` CHECK (`engine_name` REGEXP '^[a-z][a-z0-9]*([.-][a-z0-9]+)*$' AND `engine_version` <> ''),
